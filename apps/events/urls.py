...
from .views import event_list, event_detail, book_event, event_detail_api,book_event, create_event_checkout_session
...
urlpatterns = [
    ...
    path('<int:event_id>/create-checkout-session/', create_event_checkout_session, name='create_event_checkout_session'),
